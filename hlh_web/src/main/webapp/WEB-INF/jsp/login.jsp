    	...
    	<div class="layout_center">
        	<div class="user-form-wrap">
            	<div class="user-form-wraps">
                    ...
                    <form:form  action="${pageContext.request.contextPath}/user/login.do" method="post">
                    	...
                    	<div class="user-form-item">
                        	<input name="userTel" class="user-input" type="text"  placeholder="邮箱">
                        </div>
                        <div class="user-form-item">
                        	<input name="userPassword" class="user-input" type="password"  placeholder="密码">
                        </div>
                        <div class="user-form-item">
                        	<input name="qrCode" class="user-input user-input-adjust" type="text" max="4" placeholder="验证码"><img class="qrcode" style="cursor:pointer" onclick="$('.qrcode').prop('src','${pageContext.request.contextPath}/createCode.do?'+Math.random())" src="${pageContext.request.contextPath}/createCode.do">
                        </div>
                        <div class="user-form-item">
                        	<label>
                        ...
                        <div class="user-form-item">
                            <button class="user-form-button" type="submit" style="font-weight: bold;width: 320px ">登&nbsp;&nbsp;录</button>
                        </div>
                    </form:form>

                    <div class="user-form-item us_text_right">
                    	<span class="cos_span"><a>忘记密码?</a></span>&nbsp;&nbsp;<span class="cos_span_empty"><a href="${pageContext.request.contextPath}/toRegister.do">注册账号</a></span>
                    </div>
                </div>
            </div>
        </div>
