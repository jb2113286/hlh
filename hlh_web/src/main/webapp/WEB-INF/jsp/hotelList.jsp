     ...
     <div id="page-god">
    	<div class="layout_center">
                    ...
                    <li>
                    	<div class="gdx-lists-wrap layout_clear">
                        	<div class="gdx-lists-img layout_fl">
                            	<a href="toHotelDetails.do?hotelId=${hotel.hotelId}"><img src="${hotel.img.imgAdd}" style="display:block"></a>
                            </div>
                            <div class="gdx-lists-data">
                            	<h2>
                                	<a href="toHotelDetails.do?hotelId=${hotel.hotelId}">${hotel.hotelName}</a>
                                </h2>
                                ...
                                <div class="gdx-lists-heart">
                                	<span class="page_icon add-heart-out">
                                    	<span class="page_icon add-heart-in" style="${hotel.hotelStar}"></span>
                                    </span>
                                    推荐指数
                                </div>
                    ...
                    <li>
                    	<div class="gdx-list-wrap">
                        	<a href="field.html" target="_blank">
                            	<img src="/img/Yrm54858716fa.jpg" style="width:100%; display:block">
                            </a>
            ...
            <div class="ma_page">
                ...
                <a
                        href="/toHotelList.do?currentPage=${pageInfo.pageNum-1}"
                ...
                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum" step="1">
                    ...
                    <c:if test="${pageInfo.pageNum != pageNum}">
                        <a href="/toHotelList.do?currentPage=${pageNum}">${pageNum}</a>
                    </c:if>
                </c:forEach>
                <a
                        href="/toHotelList.do?currentPage=${pageInfo.pageNum+1}"
