	...
	<div id="public-navbar">
    	<div class="layout_center layout_clear" style="overflow:visible">
        	...
        	<ul class="layout_fr fl_li">
                ...
                <li>
                	<a href="toShoppingCart.do">我的购物车</a>
                </li>
                <li>
                	<span class="use-hr"></span>
                </li>
    ...
    <div id="page-godMx">
    	<div class="layout_center">
        	<div class="path">
                ...
                <span><a>特色套餐</a></span>
                <em>></em>
                <a class="cur">${myPackage.packageName}</a>
            </div>
            <div id="gods-header" class="gods-header layout_clear" style="margin-top:0px;">
                ...
                <div class="gods-header-cn layout_fl">
                    ...
                    <div class="gods-uhsale layout_clear">
                        ...
                        <div class="gods-uhsale-fr layout_fl">
                        	<span>累计评价</span>
                            <h3>${myPackage.packageSales}</h3>
                        </div>
                    </div>
                    <div class="gods-pro">
                    	<dl class="gods-pro-item layout_clear">
                        	<dt class="gods-pro-label">联系地址</dt>
                            <dd class="gods-pro-param gods-pro-primary layout_fl">${hotel.hotelAddress}</dd>
                        </dl>
                        <dl class="gods-pro-item layout_clear">
                        ...
                        <dl class="gods-pro-item layout_clear">
                            ...
                            <dd class="gods-pro-param gods-pro-primary layout_fl">
                            	<ul class="gods-pro-list gods-pro-list0" id="menus">
									<c:if test="${myPackage.packageMenuA!=null}" >
										<li onclick="menuClick('menuA')" id="menuA" class="check"><a><span>A款</span></a></li>
									</c:if>
									<c:if  test="${myPackage.packageMenuB!=null}" >
                                  		  <li onclick="menuClick('menuB')" id="menuB" class=""><a><span>B款</span></a></li>
									</c:if>
                                </ul>
                            </dd>
                        </dl>
                        <dl class="gods-pro-item layout_clear">
                            ...
                            <dd class="gods-pro-param gods-pro-primary layout_fl">
                            	<ul class="gods-pro-list gods-pro-list0" id="roomCheck">
                                    ...
                                    <li <c:if test="${status.index==0}">
                                        class="check"
                                    </c:if> onclick="roomClick('${room.roomName}')" id="${room.roomName}"
                                    ><a><span>${room.roomName}</span></a></li>
                        ...
                        <dl class="gods-pro-item layout_clear">
                            ...
                            <dd class="gods-pro-param gods-pro-primary layout_fl">
                            	<span class="gods-counter">
                                	<input id="BuyCarNumber" type="text" class="gods-counter-text" name="BuyCarNum" value="1" maxlength="3" min="1">
                                    <span class="gods-counter-btn">
                                    	<span class="gods-counter-push page_icon" title="加" onclick="add()"></span>
                                        <span class="gods-counter-reduce page_icon" title="减" onclick="sub()"></span>
                                    </span>
                        ...
                        <dl class="gods-pro-item layout_clear">
                        	<dd class="gods-pro-item layout_clear">
                                ...
                                <a onclick="addShoppingCart()" class="gods-pro-payfor">加入购物车</a>
                            </dd>
                        </dl>
                    </div>
                </div>
                <div class="gods-header-fr layout_fl">
                	<div class="gods-shop">
                        ...
                        <div class="gods-shop-logo"><img src="${hotel.img.imgAdd}" style="width:100%;height: 100%;"></div>
                        <div class="gods-shop-go"><a class="cur">进入店铺</a> <a>收藏店铺</a></div> 
                    </div>
                    <div class="gods-aside-inset"><img src="${hotel.img.imgAdd}" style="margin:auto"></div>
                    <ul class="gods-other-list">
                    	<li>
                        	<a>
                            	<div>
                    				<img src="img/LSN54767537nb.jpg" style="width:100%">
                        ...
                        <li>
                        	<a>
                            	<div>
                    				<img src="img/Hbp54860401oB.jpg" style="width:100%">
                    	...
                    	<li>
                        	<a>
                            	<div class="gods-aside-img">
                                	<img src="img/iQP54584096YB.jpg" style="width: 100%; display: block;">
                                </div>
                    ...
                    <div class="gods-swit-coloum">
                    	<div style="display:block">
                        	<div class="gods-gdx-img">
                            	<p>
                                	<img id="packageImg" src="${myPackage.packageMenuA}" style="height:1280px; width:904px">
                                </p>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function menuClick(menuID) {
        ...
        if (menuID == 'menuA'){
            $("#packageImg").prop("src","${myPackage.packageMenuA}");
        }else if (menuID == 'menuB'){
            $("#packageImg").prop("src","${myPackage.packageMenuB}");
        }
        packageType =  $("#"+menuID+" span").html();
        console.log(packageType)
    }

    function roomClick(roomName) {

        var checked = $("#"+roomName).prop("class");
        if (checked != "check"){
            $("#roomCheck li").prop("class","")
            $("#"+roomName).prop("class","check");
        }

        shoppingcartPlace = $("#"+ roomName +" span").html()
        console.log(shoppingcartPlace)

    }


    function add() {
        var num =  $("#BuyCarNumber").prop("value");
        num++
        $("#BuyCarNumber").prop("value", num);
        shoppingcartCount = num
    ...
    function addShoppingCart() {
        ...
        var shoppingcartPlace = $("#roomCheck li[class='check']").text()
        var shoppingcartCount = $("#BuyCarNumber").val()
        var shoppingcartImg = $("#packageImg").prop("src")
        $.ajax({
            type: 'POST',
            url: "addShippingCart.do",
            data: {
                ...
                "tbUserUserTel":'${sessionScope.exitsUser.userTel}',
