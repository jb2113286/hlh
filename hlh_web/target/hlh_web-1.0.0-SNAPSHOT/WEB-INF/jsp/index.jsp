...
<body>
    ...
    <div id="page-middle-bar">
    	<div class="layout_center layout_clear">
            ...
            <ul class="layout_clear layout_fl fl_li">
            	<li><a>首页</a></li>
                <li><a href="/toHotelList.do">婚宴场地</a></li>
                <li><a>婚纱摄影</a></li>
                <li><a>婚庆用车</a></li>
                <li><a>婚庆公司</a></li>
                <li><a>婚具租赁</a></li>
    ...
    <div id="page-home">
    	<div class="layout_center">
        	<div class="hm-import">
            	<div class="hm-menu">
                	<ul id="levels">
                    	<li>
                        	<a href="field.html">
                                <div class="menu-item">
                                    <i class="page_icon menu-item-fl" style="background-image:url(/img/Uvi52426432fj.jpg)"></i>
                        ...
                        <li>
                        	<div class="menu-item">
                            	<i class="page_icon menu-item-fl" style="background-image:url(/img/gnt52426455dS.jpg)"></i>
                        ...
                        <li>
                        	<div class="menu-item">
                            	<i class="page_icon menu-item-fl" style="background-image:url(/img/xEE52426490uK.jpg)"></i>
                        ...
                        <li>
                        	<div class="menu-item">
                            	<i class="page_icon menu-item-fl" style="background-image:url(/img/uoi52426512ml.jpg)"></i>
                        ...
                        <li>
                        	<div class="menu-item">
                            	<i class="page_icon menu-item-fl" style="background-image:url(/img/Hro52426532DG.jpg)"></i>
                        ...
                        <li>
                        	<div class="menu-item">
                            	<i class="page_icon menu-item-fl" style="background-image:url(/img/woO52426552Fb.jpg)"></i>
                        ...
                        <li>
                        	<div class="menu-item">
                            	<i class="page_icon menu-item-fl" style="background-image:url(/img/NqD52426576oC.jpg)"></i>
                        ...
                        <li>
                        	<div class="menu-item">
                            	<i class="page_icon menu-item-fl" style="background-image:url(/img/Wxg52426598lo.jpg)"></i>
                ...
                <div class="hm-marq">
                    ...
                    <div class="hm-marq-advert">
                    	<a><img src="/img/tLm56508041Fx.jpg"></a>
                    </div>
                </div>
            </div>
            <div class="hm-major">
            	<ul class="layout_clear fl_li">
                	<li>
                    	<a  title="我们的承诺" target="_blank">
                            <div class="nav-img">
                                <img src="/img/oCR49858095jM.jpg" alt="我们的承诺">
                            </div>
                        </a>
                        <div class="nav-lab">
                        	<h1>我们的承诺</h1>
                    ...
                    <li>
                    	<a>
                            <div class="nav-img">
                                <img src="/img/vHz49858102NT.jpg" style="width: 90px;display: block;margin: 10px auto auto 20px;">
                            </div>
                        </a>
                        <div class="nav-lab">
                        	<h1>婚前</h1>
                	...
                	<div class="hm-grid-list layout_clear">
                    	<div class="hm-grid-cover layout_fl">
                        	<div class="hm-grid-advem">
                            	<a><img src="/img/jDZ62963631uI.jpg"></a>
                            </div>
                            <div class="hm-grid-advem" style="margin-bottom:0;">
                            	<a><img src="/img/uLB62963982aT.jpg"></a>
                            </div>
                        </div>
                        <div style="width:820px;height:456px;position:relative;">
                        	<ul class="layout_clear layout_fl fl_li">
                            	<li>
                                	<div>
                                    	<a  title="湘域中餐厅">
                                        	<img src="/img/LSN54767537nb.jpg" style="display:block">
            ...
            <div class="hm-grid-floor">
                ...
                <div class="hm-grid-bd layout_clear">
                	<div class="layout-fl layout_fl">
                    	<div class="img">
                        	<a><img src="/img/EjU62361173cL.jpg"></a>
                        </div>
                    </div>
                    <div class="layout-cn layout_fl">
                    	<ul class="layout_clear fl_li">
                        	<li>
                            	<a>
                                	<img src="/img/woX62017152YC.jpg" style="display:block">
                                    <p>重庆南温泉丽筠酒店</p>
                                </a>
                            </li>
                            <li>
                        ...
                        <ul class="hm-hot-list">
                        	<li>
                                ...
                                <div class="hm-hot-child flex-down" style="display:block">
                                	<img src="/img/Yrm54858716fa.jpg" style="display:inline-block;">
            ...
            <div class="hm-advert">
            	<a href="Untitled-2.html"><img src="/img/sBk56507199Zz.jpg"></a>
            </div>
            <div class="hm-grid-floor">
            	<div class="hm-grid-hd">
                	<h1 class="hm-grid-tit layout_fl">婚宴场地</h1>
            ...
            <div class="hm-advert">
            	<a href="Untitled-2.html"><img src="/img/zKq56507283Tl.jpg"></a>
            </div>
            <div class="hm-grid-floor">
            	<div class="hm-grid-hd">
                	<h1 class="hm-grid-tit layout_fl">婚宴场地</h1>
