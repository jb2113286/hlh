...
public class SendEmail {
    ...
    //发件人的邮箱和授权码
    private final String myEmailAccount = "937158168@qq.com";//发送的邮箱
    private final String myEmailPassword = "ycxglplahdtrbbdg";
